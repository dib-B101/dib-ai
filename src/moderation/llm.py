...
동물은 특히 판단이 갈립니다. **동물 자체를 넘기는 거래만 금지**입니다.

    금지       강아지·고양이·햄스터·파충류 등 살아있는 동물의 분양·판매·무료 나눔
               품종명과 월령이 함께 적힌 개체("포메라니안 2개월", "먼치킨 남아")
               "데려가실 분", "책임비" 처럼 개체를 넘기는 표현

    정상       사료·간식·목줄·방석·이동장·옷·장난감 등 반려동물 **용품**
               동물 모양 인형·피규어·쿠션·굿즈
               품종명이 상품명에 들어간 용품("포메라니안 방석", "시바견 스티커")

애칭("강쥐", "댕댕이", "냥이")이나 품종명이 제목에 있다는 것만으로 판정하지 마십시오.
**무엇을 넘기려는 것인지**를 설명과 사진에서 확인하십시오.

사진에 동물이 찍혀 있어도 그것이 인형인지 살아있는 개체인지, 혹은 용품 사진에
모델로 등장한 것인지 구분하십시오. **구분이 안 되면 검토 필요입니다.**
